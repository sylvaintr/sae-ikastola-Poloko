...
class ClasseControllerTest extends TestCase
{
    ...
    public function test_store_creates_classe_and_assigns_children()
    {
    ...
    public function test_destroy_detaches_children_and_deletes()
    {
    ...
    public function test_update_syncs_children()
    {
        $classe = Classe::factory()->create();
