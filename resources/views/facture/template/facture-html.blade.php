...
<body>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="width: 15%; text-align: center; padding: 4pt;">2025.09.13</td>
            <td style="width: 32%; text-align: center; padding: 4pt;">&lt;&lt;Total&gt;&gt; € - eusko</td>
            <td style="width: 6%; border: none;"></td>
            <td style="width: 15%; text-align: center; padding: 4pt;">2026.03.13</td>
            <td style="width: 32%; text-align: center; padding: 4pt;">&lt;&lt;Total&gt;&gt; € - eusko</td>
        </tr>
        <tr>
