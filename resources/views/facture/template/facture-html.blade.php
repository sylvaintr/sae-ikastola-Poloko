...
<body>
    ...
    <table class="table table-bordered table-sm" style="border-collapse:collapse;margin-left:5.37pt" cellspacing="0">
        <tr style="height:32pt">
            ...
            <td class="bg-light-green"
                ...
                <p class="s7 pt-2 ps-3 text-start">BEZ gabeko orotara <span class="text-muted-gray">Total HT</span></p>
            </td>
        </tr>
        <tr style="height:28pt">
            ...
            <td
                style="width:205pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s9 pt-2 text-end"> @switch($enfants->count())
                        @case(1)
                            45
                        @break
        ...
        <tr style="height:28pt">
            <td
                ...
                <p class="s9" style="padding-top: 3pt;padding-left: 5pt;text-indent: 0pt;text-align: left;">
                    Ateraldi,
                    krakada eta horniduretarako parte-hartzea <span style=" color: #7E7E7E;">Participation pour sorties,
            ...
            <td
                style="width:128pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s11 pt-1 text-end">&lt;&lt;Participation&gt;&gt; € -</p>
                <p class="s11 text-end pe-2">eusko</p>
            </td>
        </tr>
        <tr style="height:28pt">
            ...
            <td
                style="width:128pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s11 pt-1 text-end">&lt;&lt;Calendriers&gt;&gt; € -</p>
                <p class="s11 text-end pe-2">eusko</p>
            </td>
        </tr>
        <tr style="height:29pt">
            ...
            <td
                ...
                <p class="s9 ps-3" style="line-height:11pt;">+ 9 aldiz – <span class="text-muted-gray">fois </span>: 20
                    € - eusko / haurka – <span class="text-muted-gray">enfant</span></p>
            </td>
            <td
                style="width:128pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s11 pt-3 ps-2 text-center">&lt;&lt;Garderie&gt;&gt; € - eusko</p>
            </td>
        </tr>
        <tr style="height:30pt">
            ...
            <td class="bg-green"
                style="width:128pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p class="s7 pt-3 text-center">&lt;&lt;Total&gt;&gt; € / eusko</p>
            </td>
        </tr>
    </table>
    <p class="s3 pl-26 text-start">Hileko zenbatekoa:</p>
    <h2 class="pl-26 pt-1 text-start">Montant prélevé mensuellement :</h2>
    <p class="s13 pt-2 pl-26 text-start" style="line-height:107%;">BEZ-a ez aplikagarria, ZKN-aren 293B artikulua
        <span class="text-muted-gray">TVA non applicable, article 293B du CGI</span>
    </p>
    <table style="border-collapse:collapse;margin-left:26.01pt" cellspacing="0">
