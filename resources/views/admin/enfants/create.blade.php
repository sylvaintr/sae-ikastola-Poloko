        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                ...
                <h2 class="h6 fw-semibold mb-3">
                    {{ __('enfants.create_title', [], 'eus') }}
                    @if (Lang::getLocale() == 'fr')
                        <span class="d-block fw-light text-muted">
                            {{ __('enfants.create_title') }}
                        </span>
                    @endif
                </h2>

                <form action="{{ route('admin.enfants.store') }}" method="POST" class="small">
                    @csrf
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="idClasse" name="idClasse"
                                ...
                                @foreach($classes as $classe)
                                    <option value="{{ $classe->idClasse }}" @selected(old('idClasse') == $classe->idClasse)>
