<x-app-layout>
    <div class="container py-4">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <h1 class="h4 fw-bold mb-4">{{ __('admin.accounts_page.create.title') }}</h1>

                <form method="POST" action="{{ route('admin.accounts.store') }}" class="admin-form">
                    @csrf
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input id="prenom" name="prenom" type="text" class="form-control @error('prenom') is-invalid @enderror"
                                   value="{{ old('prenom') }}" required maxlength="15">
                            @error('prenom')
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="nom" name="nom" type="text" class="form-control @error('nom') is-invalid @enderror"
                                   value="{{ old('nom') }}" required maxlength="15">
                            @error('nom')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="mdp_confirmation" class="form-label fw-semibold">{{ __('admin.accounts_page.create.fields.password_confirmation') }}</label>
                    ...
                    <div class="d-flex gap-3 mt-4 justify-content-end">
                        <a href="{{ route('admin.accounts.index') }}" class="btn admin-cancel-btn px-4">
                            {{ __('admin.accounts_page.create.cancel') }}
                        </a>
                        <button type="submit" class="btn fw-semibold px-4 admin-submit-btn">
                            {{ __('admin.accounts_page.create.submit') }}
                        </button>
                    </div>
                </form>
            </div>
