...
class ProfileController extends Controller
{
     ...
     * 10240 KB = 10 MB
     * Cette limite est sécurisée car elle :
     * - Empêche les attaques DoS par upload de fichiers volumineux
     * - Respecte les contraintes de stockage du serveur
     * - Est suffisante pour la plupart des documents administratifs (PDF, images, etc.)
     */
